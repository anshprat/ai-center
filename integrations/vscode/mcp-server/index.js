#!/usr/bin/env node
/**
 * AI Center MCP Server for VSCode (Copilot, Codex, etc.)
 * Provides AI Center tools to VSCode via MCP protocol
 */
...
async function main() {
  ...
  // Auto-register this VSCode instance
  ...
  console.error("AI Center MCP server running (VSCode)");
}
